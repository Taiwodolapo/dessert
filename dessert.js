const cart = {
    productA: { quantity: 0, price: 6.50 },
    productB: { quantity: 0, price: 7.00 },
    productC: { quantity: 0, price: 8.00 },
    productD: { quantity: 0, price: 5.50 },
    productE: { quantity: 0, price: 4.00 },
    productF: { quantity: 0, price: 5.00 },
    productG: { quantity: 0, price: 4.50 },
